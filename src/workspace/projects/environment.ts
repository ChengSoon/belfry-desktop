...
const RESERVED = /^(HOME|USERPROFILE|SHELL|COMSPEC|SYSTEMROOT|WINDIR|TERM|COLORTERM|CODEX_HOME|CODEX_SQLITE_HOME|CLAUDE_CONFIG_DIR|BELFRY_.*|NODE_OPTIONS|BASH_ENV|ENV|ZDOTDIR|LD_.*|DYLD_.*)$/i;
