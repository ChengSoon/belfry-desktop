...
/**
 * 外观设置。目前只有背景图，标题仍叫「外观」——字号、字体这类后面要加的都归这儿。
 *
 * 退出手势和焦点处理跟 ConfirmDialog 一致（useDismiss + 初始聚焦，不做焦点陷阱）。
 */
  ...
  return (
    <div className="modal-scrim">
      <div
        ...
        aria-modal="true"
        className="modal appearance"
        ref={panelRef}
        role="dialog"
      >
        <strong className="modal__title" id="appearance-title">外观设置</strong>
        ...
        <div className="modal__actions">
          <button onClick={onClose} ref={closeRef} type="button">完成</button>
        </div>
      </div>
    </div>
  );
